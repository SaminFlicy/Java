...
class lorry implements Vehicle {
    ...
    public void changeGear(int gear) {
        this.gear = gear;
        System.out.println("Lorry changed to gear " + gear);
    }

    public void accelerate(int speed) {
        this.speed += speed;
        System.out.println("Lorry accelerated to " + this.speed + " km/h");
    }
    ...
    public void brake(int speed) {
        ...
        System.out.println("Lorry slowed down to " + this.speed + " km/h");
    }
